# this is where blue prints are useful, since app is not global we are using the blueprints
...
# Variable within <> can be passed during runtime
...
# this route is for edit form which takes minimal data.
